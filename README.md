...
/*#### [ICONE DA SALA] ####*/
.icon-room {
    background: url("https://image.prntscr.com/image/L6YS1zFSQpG1lkvhCNP0XA.gif" ) no-repeat;
...
#room-settings .general-settings .panel .title {
    position: relative;
    margin-top: 10px;
    margin-left: 10px;
    float: center;
...
.tab-menu .selected, .dropdown.open {
	...
	box-shadow: inset 1px 1px 10px -1px hsla(220,80%,50%,0.5) !important;
}
.dropdown dt {
	border-radius: 10px;
...
.dropdown dd, #chat-suggestion, #dialog-user-role .role-menu .menu ul li, #search-suggestion li, #dialog-restricted-media .row.selected, {
	background: hsla(210,10%,10%,0.8) !important;
}
...
#fullscreenDisable, #friendfinder, .cbg-images, .rcs-menu-container .group, #rcs-found-update-chat, #now-playing-time, #now-playing-dj .username, #woot-rs-list p, #grab-rs-list p, #meh-rs-list p, #waitlist .list .user .name, .friends .list .name {
    cursor: pointer;
    color: #FFF;
}
#volume {
...
#woot i.icon, #grab i.icon, #meh i.icon {
...
#user-rollover .info {
	background: none;
	box-shadow: 0px -2px 10px -1px #6dc3e0;
...
.thumb.large, .thumb, #user-rollover .meta.online .thumb {
	border-color: hsl(197, 72%, 58%) !important;
	box-shadow: 0 0 7px hsl(197, 72%, 58%) !important;
}
.thumb.large, #user-rollover .meta.online .thumb.large {
	box-shadow: 0 0 15px hsl(197, 72%, 58%) !important;
}
#waitlist .list .user {
    position: relative;
    overflow: hidden;
    width: 100%;
    height: 41px;
    background: rgba(41, 48, 105, 0.48);
}
...
/*#### [TAG PERFIL] ####*/
	...
	/*## [TAG-BOT] ##*/
        ...
        /*# [ReiFada] #*/
#user-rollover.id-36860967 .level:after {
    background-image: url(none);
    background-repeat: no-repeat;
    content: "[BOT]";
    display: inline-block;
    color: #44e7ed!important;
    font-weight: bold;
	...
	/*## [TAG-VIP] ##*/
       ...
       /*# [Mateusk] #*/
#user-rollover.id-32937367 .level:after {
    background-image: url(none);
    background-repeat: no-repeat;
    content: "[BLOOM]";
    display: inline-block;
    color: #de3be5!important;
    font-weight: bold;
    margin: 0px 0px 0 20px!important;
    padding: 0 0 0 18px;
}
       /*# [ninguem] #*/
#user-rollover.id-000000 .level:after {
    background-image: url(none);
    background-repeat: no-repeat;
    content: "[VIP]";
    display: inline-block;
    color: #e2da24!important;
    font-weight: bold;
    margin: 0px 0px 0 20px!important;
    padding: 0 0 0 18px;
}
...
#chat-messages::-webkit-scrollbar, .dropdown dd::-webkit-scrollbar, #woot-rs-list::-webkit-scrollbar, #grab-rs-list::-webkit-scrollbar, #meh-rs-list::-webkit-scrollbar, .dialog::-webkit-scrollbar {
    width: 7px !important;
    box-shadow: inset -1px 0 7px hsla(203, 98%, 46%, 0.7);
}
#chat-messages .text {
    position: relative;
...
#chat-messages {
	border-color: #555;
	box-shadow: 0 51px 0 rgba(30,35,40,0.7);
}
...
.dialog::-webkit-scrollbar {
	width: 7px !important;
	box-shadow: inset -1px 0 7px hsla(0,0%,0%,0.7);
}
...
.jspDrag {
	...
	box-shadow: inset 1px 0 7px hsla(0,0%,100%,0.5);
	border-radius: 5px;
}
...
.app-right .friends .list-header .input-background {
    ...
    background: linear-gradient(to top, hsla(220, 5%, 64%, 0.34), hsla(219, 66%, 50%, 0.2));
...
#chat .log .text {
    ...
    box-shadow: inset 0px 0px 17px 3px #798892;
}
#chat .log {
	background: linear-gradient(hsla(220,30%,20%,0.8), hsla(220,30%,15%,0.8)),
	linear-gradient(to right, hsla(0,0%,0%,0), hsla(0,0%,100%,0.2)) !important;
	box-shadow: inset 0 -1px 1px hsla(220,30%,10%,0.8);
}
.cm strong {
	color: #fff !important;
}
...
/*#### [MODERATION] ####*/
#chat .cm.moderation {
	background: linear-gradient(hsla(260,50%,25%,0.8), hsla(260,50%,15%,0.8)),
	linear-gradient(to right, hsla(0,0%,0%,0), hsla(0,0%,100%,0.2)) !important;
...
/*#### [USER-ACTION] ####*/
#chat .cm.user-action {
	background: linear-gradient(hsla(60,100%,20%,0.8), hsla(60,100%,10%,0.8)),
	linear-gradient(to right, hsla(0,0%,0%,0), hsla(0,0%,100%,0.2)) !important;
...
#chat .cm.mention {
	background: linear-gradient(hsla(77,100%,20%,0.8), hsla(77,100%,11%,0.8)),
	linear-gradient(to right, hsla(0,0%,0%,0), hsla(0,0%,100%,0.2)) !important;
...
/*#### [BOT] ####*/
#chat .cm.emote {
    background: linear-gradient(hsl(235, 65%, 19%), hsl(235, 65%, 19%)), linear-gradient(to right, hsl(0, 0%, 0%), hsl(0, 0%, 0%)) !important;
    border-left: none !important;
    text-align: left;
    box-shadow: inset 0 0 0px 1px hsla(237, 100%, 50%, 0.5);
}
...
.app-right {
	background: hsla(210,10%,5%,0.9) !important;
}
#rcs-progress-container .bar {
    background-color: rgba(11, 128, 243, 0.73);
}
#rcs-menu-container .container .group {
	border-color: hsl(220,50%,20%) !important;
	background: linear-gradient(hsla(220,50%,10%,0.8), hsla(220,50%,7%,0.8)) !important;
}
...
/*#### [TAG-ANTES-DO-NOME] ####*/
    ...
    /*## [BOT] ##*/
        ...
        /*# [ReiFada] #*/
#chat [data-cid^='36860967-'] .un:before {
    content: '[BOT]';
    top: 0px;
    Left: 0px;
	color: #44e7ed!important;
    ...
    position: relative;
        ...
        /*# [TAG-VIP] #*/
		/*# Mateusk #*/
#chat [data-cid^='32937367-'] .un:before {
    content: '[BLOOM]';
    top: 0px;
    Left: 0px;
	color: #de3be5!important;
    ...
    position: relative;
		...
		/*# ninguem #*/
#chat [data-cid^='000000-'] .un:before {
    content: '[VIP]';
    top: 0px;
    Left: 0px;
	color: #e2da24!important;
    ...
    position: relative;
		...
		/*# Percyvall #*/
#chat [data-cid^='29319764-'] .un:before {
    content: '[VIP]';
    top: 0px;
    Left: 0px;
	color: #e2da24!important;
...
/*#### [EMBLEMA-CUSTOM] ####*/
    ...
    /*## [Staff] ##*/
        ...
        /*# [NightPlug] #*/
#user-rollover.id-30619682 .badge-box > i.bdg,
.id-30619682 > .badge-box > i.bdg
{
    background-image:    url("https://image.prntscr.com/image/L6YS1zFSQpG1lkvhCNP0XA.gif");
}
        /*# [Percyvall] #*/
#user-rollover.id-29319764 .badge-box > i.bdg,
.id-29319764 > .badge-box > i.bdg
{
	background-image:   url("https://image.prntscr.com/image/VQWEV9GfT4K1mpg2ykFWvg.gif");
}
